<template>
  <div>
     <header v-if="$route.meta.show">
         ...
         <div class="left-sidebar"  v-if="$route.meta.show">
            <!-- 用户信息 -->
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                   <router-link to="/index" class="active"> <i class="am-icon-home sidebar-nav-link-logo"></i>首页</router-link>
                </li>
                <li class="sidebar-nav-link">
                   <router-link to="/addfoods" class="a">   <i class="am-icon-table sidebar-nav-link-logo"></i>商品管理</router-link>
          
                </li>
                <li class="sidebar-nav-link">
                  <router-link to="/upfoods" class="a"><i class="am-icon-calendar sidebar-nav-link-logo"></i>已下架商品</router-link>
            
                </li>
                <li class="sidebar-nav-link">
                   <router-link to="/cs" class="a"> <i class="am-icon-wpforms sidebar-nav-link-logo"></i>添加商品</router-link>
